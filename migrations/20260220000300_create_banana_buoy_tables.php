...
final class CreateBananaBuoyTables extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $this->execute("
            ...
            ('Red Dacca', '🇮🇳 India', 'Rich and sweet with berry undertones and soft texture', '$IMAGE_HOST/banana-buoy/products/red-dacca.webp', 'Red Dacca banana with deep maroon colored skin', 5.49),
            ('Saba', '🇵🇭 Philippines', 'Starchy and slightly tangy, perfect for cooking', '$IMAGE_HOST/banana-buoy/products/saba.webp', 'Saba cooking banana with angular shape', 3.99),
            ('Lady Finger', '🇦🇺 Australia', 'Exceptionally sweet and creamy with delicate texture', '$IMAGE_HOST/banana-buoy/products/lady-finger.webp', 'Small Lady Finger bananas in a bunch', 6.99),
            ('Manzano', '🇲🇽 Mexico', 'Apple-strawberry flavor with hints of honey', '$IMAGE_HOST/banana-buoy/products/manzano.webp', 'Chubby Manzano apple bananas with yellow skin', 5.99),
            ('Burro', '🇲🇽 Mexico', 'Tangy lemon flavor when unripe, sweet when ripe', '$IMAGE_HOST/banana-buoy/products/burro.webp', 'Square-shaped Burro bananas', 4.49),
            ('Cavendish', '🇪🇨 Ecuador', 'Classic sweet banana flavor, perfectly balanced', '$IMAGE_HOST/banana-buoy/products/cavendish.webp', 'Traditional Cavendish bananas in a bunch', 2.99),
            ('Pisang Raja', '🇮🇩 Indonesia', 'Honey-sweet with rich, dense texture', '$IMAGE_HOST/banana-buoy/products/pisang-raja.webp', 'Golden Pisang Raja King bananas', 7.49),
            ('Goldfinger', '🇭🇳 Honduras', 'Crisp apple-like texture with sweet flavor', '$IMAGE_HOST/banana-buoy/products/goldfinger.webp', 'Goldfinger bananas with distinctive shape', 5.79),
            ('Gros Michel', '🇹🇭 Thailand', 'Traditional banana flavor, creamier than Cavendish', '$IMAGE_HOST/banana-buoy/products/gros-michel.webp', 'Large Gros Michel Big Mike bananas', 6.49),
            ('Plantain', '🇨🇴 Colombia', 'Starchy and savory, ideal for frying', '$IMAGE_HOST/banana-buoy/products/platain.webp', 'Green plantains ready for cooking', 3.49),
            ('Lakatan', '🇵🇭 Philippines', 'Orange-fleshed with sweet tangy flavor', '$IMAGE_HOST/banana-buoy/products/lakatan.webp', 'Lakatan bananas with orange-tinted flesh', 5.29),
            ('Mysore', '🇮🇳 India', 'Mild sweet flavor with hint of tartness', '$IMAGE_HOST/banana-buoy/products/mysore.webp', 'Mysore bananas with thin yellow skin', 4.79),
            ('Nanjangud', '🇮🇳 India', 'Aromatic with complex sweet flavor profile', '$IMAGE_HOST/banana-buoy/products/nanjangud.webp', 'Premium Nanjangud GI tagged bananas', 8.99),
            ('Praying Hands', '🇮🇩 Indonesia', 'Sweet and creamy with unique fused fingers', '$IMAGE_HOST/banana-buoy/products/praying-hands.webp', 'Rare Praying Hands bananas fused together', 12.99),
            ('Red Spanish', '🇨🇺 Cuba', 'Sweet with raspberry hints and pink flesh', '$IMAGE_HOST/banana-buoy/products/red-spanish.webp', 'Red Spanish bananas with reddish-purple peel', 6.99),
            ('Matoke', '🇺🇬 Uganda', 'Green cooking banana, starchy and mild', '$IMAGE_HOST/banana-buoy/products/matoke.webp', 'Matoke green cooking bananas', 3.99),
            ('Grand Nain', '🇨🇷 Costa Rica', 'Similar to Cavendish, slightly sweeter', '$IMAGE_HOST/banana-buoy/products/grand-nain.webp', 'Grand Nain bananas premium quality', 3.49),
            ('Williams', '🇦🇺 Australia', 'Bright yellow with classic sweet taste', '$IMAGE_HOST/banana-buoy/products/williams.webp', 'Williams hybrid bananas', 3.99),
            ('Dwarf Cavendish', '🇪🇸 Canary Islands', 'Compact variety with intense sweetness', '$IMAGE_HOST/banana-buoy/products/dwarf-cavendish.webp', 'Small Dwarf Cavendish bananas', 4.99),
            ('Fehi', '🇵🇫 Polynesia', 'Orange flesh, used for cooking, vitamin A rich', '$IMAGE_HOST/banana-buoy/products/fehi.webp', 'Fehi cooking bananas with orange interior', 7.99),
            ('Cardaba', '🇵🇭 Philippines', 'Dense and starchy, perfect for banana cue', '$IMAGE_HOST/banana-buoy/products/cardaba.webp', 'Cardaba cooking bananas angular shape', 3.79),
            ('Ney Poovan', '🇮🇳 India', 'Aromatic small banana with intense flavor', '$IMAGE_HOST/banana-buoy/products/ney-poovan.webp', 'Ney Poovan baby bananas premium', 6.49),
            ('Barangan', '🇲🇾 Malaysia', 'Yellow-orange flesh, sweet and fragrant', '$IMAGE_HOST/banana-buoy/products/barangan.webp', 'Barangan bananas Malaysian variety', 5.99),
            ('Bluggoe', '🌎 Americas', 'Silver-bluish peel, tangy cooking variety', '$IMAGE_HOST/banana-buoy/products/bluggoe.webp', 'Bluggoe silver bananas for cooking', 4.29),
            ('Ice Cream', '🇵🇭 Philippines', 'Blue Java type with vanilla custard taste', '$IMAGE_HOST/banana-buoy/products/ice-cream.webp', 'Ice Cream bananas with blue-tinged peel', 7.99),
            ('Thousand Fingers', '🌍 Africa', 'Numerous small fingers, sweet when ripe', '$IMAGE_HOST/banana-buoy/products/thousand-fingers.webp', 'Thousand Fingers banana bunch with many fruits', 9.99),
            ('Señorita', '🇵🇭 Philippines', 'Tiny sweet bananas, rich flavor', '$IMAGE_HOST/banana-buoy/products/senorita.webp', 'Señorita miniature bananas', 5.49),
            ('Rhino Horn', '🌍 Africa', 'Extremely long banana, mild sweet flavor', '$IMAGE_HOST/banana-buoy/products/rhino-horn.webp', 'Rhino Horn banana extraordinarily long', 11.99),
            ('Kandrian', '🇵🇬 Papua New Guinea', 'Rare heritage variety, complex flavor', '$IMAGE_HOST/banana-buoy/products/kandrian.webp', 'Kandrian heritage bananas rare variety', 13.99)
        ");
        ...
        $this->execute("
            ...
            (
                ...
                '2026-02-12',
                '$IMAGE_HOST/banana-buoy/news/banana-pectin-fiber structure.webp',
            ...
            (
                ...
                '2026-02-10',
                '$IMAGE_HOST/banana-buoy/news/seawater-to-hydrogen.webp',
            ...
            (
                ...
                '2026-02-08',
                '$IMAGE_HOST/banana-buoy/news/researchers-analyzing-banana-fiber-samples-in-laboratory.webp',
            ...
            (
                ...
                '2026-02-05',
                '$IMAGE_HOST/banana-buoy/news/hydrogen-powered-vessel-at-port.webp',
            ...
            (
                ...
                '2026-02-03',
                '$IMAGE_HOST/banana-buoy/news/banana-plantation.webp',
                'Sunset view of banana plantation with rows of banana plants'
            ),
            (
                ...
                '2026-01-30',
                '$IMAGE_HOST/banana-buoy/news/technician-installing-advanced-pem-electrolyzer.webp',
            ...
            (
                ...
                '2026-01-25',
                '$IMAGE_HOST/banana-buoy/news/green-and-yellow-bananas.webp',
                'Bananas at different ripeness stages showing green and yellow colors'
            ),
            (
                ...
                '2026-01-20',
                '$IMAGE_HOST/banana-buoy/news/engineer-inspecting-hydrogen-safety-monitoring-system.webp',
            ...
            (
                ...
                '2026-01-15',
                '$IMAGE_HOST/banana-buoy/news/banana-refrigerator.webp',
                'Banana from refrigeration unit showing vibrant color and firm texture'
            )
        ");
    }
}
